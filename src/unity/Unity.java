...
public class Unity {
    ...
    public static void main(String[] args) {
            ...
            String sql4 = "CREATE TABLE cart3 (isbn INTEGER NOT NULL, seller VARCHAR NOT NULL, price DOUBLE NOT NULL, "
                    ...
                    + "condition VARCHAR NOT NULL, description TEXT, PRIMARY KEY (isbn, seller, price))";
            String sql5 = "CREATE TABLE address (buyer VARCHAR NOT NULL  DEFAULT (null) ,shipping TEXT NOT NULL) ";
            String sql7 = "CREATE TABLE \"cardInfo1\" (\"cardNumber\" INTEGER PRIMARY KEY  NOT NULL , \"buyer\" VARCHAR NOT NULL , \"billing\" TEXT NOT NULL , \"cardName\" VARCHAR NOT NULL , \"cardType\" VARCHAR NOT NULL , \"expDate\" VARCHAR NOT NULL , \"securityNumber\" INTEGER NOT NULL , \"phone\" VARCHAR NOT NULL )";
