...
public class trackCancel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        homeBtn.setFont(new java.awt.Font("LSTKClarendon", 1, 24)); // NOI18N
        ...
        cancelOrderBtn.setBackground(new java.awt.Color(255, 255, 204));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/unity/panther.png"))); // NOI18N
    ...
    private void cancelOrderBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cancelOrderBtnMouseClicked
        try {
            ...
            String buye = "sold" + login.getValue();
                ...
                String query = "update pay set buyer = 'cancel' WHERE buyer = '"+buye+"' AND isbn = '"+isb+"'"
